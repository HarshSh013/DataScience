...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Skin Cancer Detection Apps"))
    ...
    def predict_result(self):
        print(result)
        if result[0][0]>0.5:
            print("Affected By Benign")
            speak("Affected By Benign")
        else:
            print("Affected By Malignant")
            speak("Affected By Malignant")
